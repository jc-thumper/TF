odoo.define('shipstation_delivery.dashboard', function (require) {
'use strict';
...
var Dashboard = AbstractAction.extend({
    ...
    contentTemplate: 'shipstation_delivery.dashboard_main',
    events: {
...
//        this.hidden_apps = JSON.parse(local_storage.getItem('website_dashboard_hidden_app_ids') || '[]');
        ...
        this.dashboards_templates = ['shipstation_delivery.ship_operation'];
        this.graphs = [];
    },
   ...
   fetch_data: function() {
       var self = this;
        return this._rpc({
            route: '/shipstation/get_dashboard_data',
            params: {},
    ...
    render_dashboards: function() {
        ...
        _.each(this.dashboards_templates, function(template) {
            self.$('.dashboard_operation').append(QWeb.render(template, {widget: self}));
        });
    },
...
//            self.$('.dashboard_operation').empty();
//            self.render_dashboards();
//            self.render_graphs();
//        });
...
//        this.update_cp();
    ...
    update_cp: function() {
        var self = this;
        if (!this.$searchview) {
            this.$searchview = $(QWeb.render("shipstation_delivery.DateRangeButtons", {
                widget: this,
            }));
...
core.action_registry.add('shipstation_dashboard', Dashboard);
